...
export type CategoryImageQueryQueryVariables = Exact<{ [key: string]: never }>

export type CategoryImageQueryQuery = {
  cmsCategoryImage: { sections: Array<{ data: any; name: string }> } | null
}
