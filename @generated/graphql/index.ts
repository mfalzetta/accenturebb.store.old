...
export type CmsPlpParametersCollectionBrandIdArgs = {
...
export type CmsPlpParametersCollectionFilterInput = {
  brandId: InputMaybe<DateQueryOperatorInput>;
...
export type ProductDetailsFragment_ProductFragment = { sku: string, name: string, gtin: string, description: string, id: string, isVariantOf: { productGroupID: string, name: string, hasVariant: Array<{ gtin: string, description: string, name: string, productID: string, sku: string, slug: string, image: Array<{ alternateName: string, url: string }>, breadcrumbList: { numberOfItems: number, itemListElement: Array<{ item: string, name: string, position: number }> }, brand: { name: string }, aggregateRating: { ratingValue: number, reviewCount: number }, additionalProperty: Array<{ name: string, propertyID: string, value: any, valueReference: string }> }> }, image: Array<{ url: string, alternateName: string }>, brand: { name: string }, offers: { lowPrice: number, offers: Array<{ availability: string, price: number, listPrice: number, seller: { identifier: string } }> }, breadcrumbList: { itemListElement: Array<{ item: string, name: string, position: number }> }, additionalProperty: Array<{ propertyID: string, name: string, value: any, valueReference: string }> };
